...
import com.funds4good.Security.CustomUserDetailService;
import com.funds4good.Security.JwtAuthenticationEntryPoint;
import com.funds4good.Security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain configure(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(mvc.pattern("/api/loans/getAll")).permitAll()
