...
import com.funds4good.Payloads.JwtAccessTokenResponse;
import com.funds4good.Payloads.JwtAuthResponse;
import com.funds4good.Repository.UserRepo;
import com.funds4good.Security.JwtTokenHelper;
            ...
            try {
                ...
                if(username.startsWith("#refresh")) {
                    ...
                    if (this.jwtTokenHelper.validateRefreshToken(token, userDetails)) {
                        String myAccessToken = this.jwtTokenHelper.generateAccessToken(userDetails);
                        return new ResponseEntity<>(new JwtAccessTokenResponse(myAccessToken, user.getName(), finalUsername, user.getRoles()), OK);
                    }
                    else {
